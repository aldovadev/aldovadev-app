...
const Logo = () => {
    const bgRef = useRef();
    const outline1LogoRef = useRef();
    const outline2LogoRef = useRef();
    const outline3LogoRef = useRef();
    ...
    useEffect(() => {
        ...
        // .from(outline1LogoRef.current,{
        //     drawSVG: 0,
        //     duration: 15,
        // })
        // .from(outline2LogoRef.current,{
        //     drawSVG: 0,
        //     duration: 7,
        // })
        // .from(outline3LogoRef.current,{
        //     drawSVG: 0,
        //     duration: 3,
        // })
        gsap.fromTo(
